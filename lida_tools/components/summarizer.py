...
import pandas as pd
from lida_tools.utils import clean_code_snippet, read_dataframe
from lida_tools.datamodel import TextGenerationConfig
...
class Summarizer():
    ...
    def get_column_properties(self, df: pd.DataFrame, n_samples: int = 1) -> list[dict]:
        ...
        #print ("#########################")
        #print("data properties:", properties_list)
    ...
    def summarize(
            ...
            text_gen: TextGenerator, file_name="", n_samples: int = 1,
            textgen_config=TextGenerationConfig(n=1),
            summary_method: str = "columns", encoding: str = 'utf-8') -> dict:
